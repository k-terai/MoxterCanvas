    ...
    public sealed class Project : NotifyPropertyChangedBase
    {
        ...
        public DirectoryInfo AssetsDirectory
        {
            get
            {
                ...
                else if (_assetsDirectory == null)
                {
                    _assetsDirectory = new DirectoryInfo(path);
                }
        ...
        public DirectoryInfo RuntimesDirectory
        {
            get
            {
                ...
                else if (_runtimesDirectory == null)
                {
                    _runtimesDirectory = new DirectoryInfo(path);
                }
        ...
        public DirectoryInfo PluginsDirectory
        {
            get
            {
                ...
                else if (_pluginsDirectory == null)
                {
                    _pluginsDirectory = new DirectoryInfo(path);
                }
        ...
        public DirectoryInfo ProjectSettingsDirectory
        {
            get
            {
                ...
                else if (_projectSettingsDirectory == null)
                {
                    _projectSettingsDirectory = new DirectoryInfo(path);
                }
        ...
        public DirectoryInfo UserSettingsDirectory
        {
            get
            {
                ...
                else if (_userSettingsDirectory == null)
                {
                    _userSettingsDirectory = new DirectoryInfo(path);
                }
