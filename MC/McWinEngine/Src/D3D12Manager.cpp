...
using namespace std;
using namespace McWinEngine;
using namespace McEnCore;
using namespace DirectX::SimpleMath;

McWinEngine::D3D12Manager s_instance;

McWinEngine::D3D12Manager::D3D12Manager() : m_febceValue(0)
{

}

McWinEngine::D3D12Manager::~D3D12Manager()
{
	m_fence.reset();
	m_rtvHeap.reset();
	m_allocator.reset();
...
bool McWinEngine::D3D12Manager::Initialize(const McEnCore::whandle handle)
{
#ifdef _DEBUG
	EnableDebugLayer();
#endif
...
bool McWinEngine::D3D12Manager::InitializeFactory()
{
...
bool McWinEngine::D3D12Manager::InitializeCommands()
{
...
bool McWinEngine::D3D12Manager::InitializeSwapChain(McEnCore::whandle handle)
{
...
bool McWinEngine::D3D12Manager::InitializeRenderTargetView()
{
...
bool McWinEngine::D3D12Manager::InitializeFence()
{
...
bool McWinEngine::D3D12Manager::EnableDebugLayer()
{
...
bool McWinEngine::D3D12Manager::TestClearRenderTarget()
{
...
bool McWinEngine::D3D12Manager::TestVertexCreate()
{
	Vector3 vertices[] =
	{
		{-1.0f,-1.0f,0.0f},
